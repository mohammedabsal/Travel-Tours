...
export default function Navbar() {
  ...
  return (
    <Motion.nav
      ...
      className={`fixed left-0 right-0 top-0 z-50 w-full px-3 sm:px-6 transition-all backdrop-blur-md 
      ${scroll ? "bg-white/10 shadow-lg" : "bg-white/5"} 
    ...
    >
      ...
      {/* inner container */}
      <div className="flex items-center justify-between w-full py-3 text-emerald-50">
      ...
      <Motion.div
        ...
        className="md:hidden w-full overflow-hidden px-1"
      >
        <div className="mt-2 mb-3 bg-white/10 backdrop-blur-xl rounded-xl p-4 space-y-3 w-full">
          <a className="nav-link block text-lg" href={`${base}#services`} onClick={(e) => navigateToHash(e, "services")}>Services</a>
          <a className="nav-link block text-lg" href={`${base}#packages`} onClick={(e) => navigateToHash(e, "packages")}>Packages</a>
          <a className="nav-link block text-lg" href={`${base}#gallery`} onClick={(e) => navigateToHash(e, "gallery")}>Gallery</a>
          <a className="nav-link block text-lg" href={`${base}#contact`} onClick={(e) => navigateToHash(e, "contact")}>Contact</a>
        </div>
      </Motion.div>
    </Motion.nav>
  );
